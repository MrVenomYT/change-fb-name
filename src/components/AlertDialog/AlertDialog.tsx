...
import stylesCore from "@/css/modules/core.module.scss";
            ...
            const promises = (id: number) => new Promise<AlertResponse>((resolve) => {
                ...
                options.value.buttons = options.value.buttons.map((btn: Buttons, index: number) => {
                    ...
                    const newHandler = (button: Record<string, any>) => {
                        const result: Record<string, any> = ({...button, index});
                        
                        if (Object.keys(result).includes("handler")) {
        ...
        return (
            <>
                ...
                >
                    {this.show && (
                        <>
                            <div class={styles.alert_view_overlay} onClick={this.dismissFn}>
                                <div class={[styles.alert_view_container, {[styles.alert_animate]: this.animated}]}>
                                    <div class={styles.alert_view}>
                                    ...
                                    {this.options.showTimer && (
                                        <div class={styles.alert_timer}>
                                            <div class={[stylesCore.progress, styles.alert_timer_progress]}>
                                                <div
                                                    class={stylesCore.progress_bar}
